    ...
    <AppShell header={{ height: 60 }} padding="md">
      ...
      <AppShell.Main className="main">
        <Stack c="white" gap="lg" my="4rem" align="center">
          <Image src={LogoPNG.src} alt="where is logo" maw="6rem" />
        ...
        >
          ...
          <Flex gap="lg" p="md" wrap="wrap" justify="center" maw={900}>
            <Image className="logo-img" alt="logo" src={Pitch.src} />
            <Image className="logo-img" alt="logo" src={Census.src} />
            <Image className="logo-img" alt="logo" src={EpicGames.src} />
            <Image className="logo-img" alt="logo" src={ComCast.src} />
            <Image className="logo-img" alt="logo" src={Pocket.src} />
            <Image className="logo-img" alt="logo" src={Dashlane.src} />
            <Image className="logo-img" alt="logo" src={Ruter.src} />
            <Image className="logo-img" alt="logo" src={StarAtlas.src} />
          </Flex>
        </Stack>
